...
class XmlHelper:
    ...
    @staticmethod
    @validate_call
    def serialize_to_xml(value: Any, root_element_name: str) -> str:
    ...
    @staticmethod
    @validate_call
    def serialize_list_to_xml(value: List[Any], root_element_name: str, array_item_name: str) -> str:
    ...
    @staticmethod
    @validate_call
    def serialize_dict_to_xml(value: Dict[str, Any], root_element_name: str) -> str:
    ...
    @staticmethod
    @validate_call(config=dict(arbitrary_types_allowed=True))
    def add_list_as_subelement(root: ET.Element, items: List[Any], item_name: str,
